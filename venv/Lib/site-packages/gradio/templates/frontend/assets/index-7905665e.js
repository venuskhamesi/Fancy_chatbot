...
const ENTRY_CSS = "./assets/index-e657421a.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-a19f568c.js').then(n => n.I),true?["./Index-a19f568c.js","./Index-52a9d5ff.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-7905665e.js.map
